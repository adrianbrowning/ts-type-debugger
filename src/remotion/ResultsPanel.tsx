...
import { LAYOUT, COLORS, TRACE_TYPE_COLORS } from './config';
import { VideoTraceStep, formatResult, formatParameters } from '../videoGenerator';
...
/**
 * Renders current evaluation step information
 */
